...
function App() {
  ...
  let valueDollars = 15;
  let valueDollarToEuro;
  let valueDollarToDong;
  ...
  function dollarToEuro(valueInDollars) {
    valueDollarToEuro = valueInDollars * DOLLAR_TO_EURO_RATIO;
    return valueDollarToEuro;
  }

  // TODO : You need to implement and call this function in your JSX code
  // Convert the given value in dollars to a value in dong
  function dollarToDong(valueInDollars) {
    valueDollarToDong = valueInDollars * DOLLAR_TO_DONG_RATIO;
    return valueDollarToDong;
  }
